...
<head>
  ...
  <script type="text/javascript" src='resources/blogpage/js/ajaxReply.js'></script>
    ...
    <div class="container">
      <div class="row no-gutters slider-text align-items-center justify-content-center">
        <div class="col-md-9 pt-5 text-center">
          <p class="breadcrumbs"><span class="mr-2"><a href="perBlog?mem_id=${blogDetail.mem_id}"><i class="fa fa-chevron-left"></i>${blogDetail.mem_id} 님의 블로그<i class="fa fa-chevron-right"></i></a></span></p>
          <h1 class="mb-0 bread">${blogDetail.post_title}</h1>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 blog-single">
          <h2 class="mb-3">${blogDetail.post_title}</h2>
          <!-- <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reiciendis, eius mollitia suscipit, quisquam doloremque distinctio perferendis et doloribus unde architecto optio laboriosam porro adipisci sapiente officiis nemo accusamus ad praesentium? Esse minima nisi et. Dolore perferendis, enim praesentium omnis, iste doloremque quia officia optio deserunt molestiae voluptates soluta architecto tempora.</p> -->
          <p>
            <img src="resources/blogpage/upload/${blogDetail.img_save}" alt="" class="img-fluid">
          </p>
          ...
          <div class="tag-widget post-tag-container mb-5 mt-5" style = "float: right;">
            <div class="tagcloud">
            <c:choose>
              <c:when test="${sessionScope.mem_id == blogDetail.mem_id}">
              	<a href="modifyPost?post_code=${blogDetail.post_code}" class="tag-cloud-link">수정</a>
              	<a href="deletePost?post_code=${blogDetail.post_code}" class="tag-cloud-link">삭제</a>
              </c:when>
            </c:choose>
          ...
          <div class="about-author d-flex p-4 bg-light rounded" style ="clear:both;">
            <div class="bio mr-5">
              <a href='perBlog'><img src="resources/images/person_1.jpg" alt="Image placeholder" class="img-fluid mb-4"></a>
            </div>
            <div class="desc">
              <a href='perBlog?mem_id=${blogDetail.mem_id}'><h3>${blogDetail.mem_id}</h3></a>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ducimus itaque, autem necessitatibus voluptate quod mollitia delectus aut, sunt placeat nam vero culpa sapiente consectetur similique, inventore eos fugit cupiditate numquam!</p>
            </div>
          </div>

		
		<!-- ul태그 밑으로 댓글 리스트 동적 생성 -->
          <div class="pt-5 mt-5">
            <h3 class="mb-5" style="font-size: 28px; font-weight: bold;">${countReply}&nbsp;개의 댓글</h3>
            ...
            <div class="comment-form-wrap pt-5">
              <h3 class="mb-5" style="font-size: 28px; font-weight: bold;">댓글 달기</h3>
              <form class="p-4 p-lg-5 comment-form" id='replyForm'>
                <div class="row">
                  <div class="col-md-6">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <input type='hidden' id='post_code' name='post_code' value='${param.post_code}'>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <input type="button" value="댓글추가" class="btn py-3 px-4 btn-primary" id='insertReply'>
                    </div>
                  </div>
                </div>
        ...
        <div class="col-lg-4 sidebar pl-md-4">
          <div class="sidebar-box bg-light rounded">
            <form action="#" class="search-form">
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="구글검색...">
              </div>
            </form>
          </div>
          ...
          <div class="sidebar-box">
            <h3>블로그 최신 글</h3>
            <c:forEach items='${blogList3 }' var="blogList3">
            <div class="block-21 mb-4 d-flex">
              <a class="blog-img mr-4" style="background-image: url(resources/blogpage/upload/${blogList3.img_save});" href="gotoDetail?post_code=${blogList3.post_code}"></a>
              <div class="text">
                <h3 class="heading"><a href="gotoDetail?post_code=${blogList3.post_code}">${blogList3.post_title}</a></h3>
                <div class="meta">
                  <div><a><span class="fa fa-calendar"></span> ${blogList3.post_date }</a></div>
                  <div><a><span class="fa fa-user"></span> ${blogList3.mem_id}</a></div>
                  <div><a><span class="fa fa-comment"></span> 19</a></div>
                </div>
              </div>
            </div>
            </c:forEach>
