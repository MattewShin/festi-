    ...
    <div class="container">
      <div class="row no-gutters slider-text align-items-center justify-content-center">
        <div class="col-md-9 pt-5 text-center">
          <p class="breadcrumbs"><span class="mr-2"><a href="index">Home <i class="fa fa-chevron-right"></i></a></span> <span>Contact <i class="fa fa-chevron-right"></i></span></p>
          ...
          <div class="wrapper">
            <div class="row g-0">
              ...
              <div class="col-lg-6 d-flex align-items-stretch">
                <div class="img w-100" style="background-image: url(resources/images/about.jpg);"></div>
              </div>
            </div>
          </div>
        </div>
