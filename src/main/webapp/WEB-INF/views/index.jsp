...
<body>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<c:choose>
					<c:when test="${empty mem_id}">
						<p class="mb-0">
							<a href="login" class="btn btn-primary rounded"><span
								class="ion-ios-add"></span>로그인</a>
						</p>
					</c:when>
					<c:when test="${not empty mem_id}">
						<p class="mb-0">
							<a href="logout" class="btn btn-primary rounded"><span
								class="ion-ios-add"></span>로그아웃</a>
						</p>
					</c:when>
				</c:choose>
			</div>
									...
									<div
										...
										<a href="#"
											class="btn btn-primary d-block w-100 d-flex align-items-center justify-content-center py-3"><span><i
												class="ion-ios-search"></i> Search</span></a>
									</div>
								</div>
							</div>
						</div>
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-8 heading-section text-center mb-5"
					...
					<span class="subheading">TOP4 FESTIVAL</span>
				...
				<c:forEach items="${top}" var="top">
					<div class="col-md-6 col-lg-3 d-flex align-items-stretch"
						...
						<div class="listing-wrap">
							<a href="resources/images/list_exe.png"
								class="img img-property d-flex align-items-center justify-content-center glightbox"
								style="background-image: url(resources/images/list_exe.png);">
							...
							<div class="text text-center">
								...
								<h3>
									<a onclick="movepage()">${top.fest_name}</a>
								</h3>
								<ul class="">
									<li><p>
											<span class="ion-ios-pin"></span>${top.fest_place }
										</p></li>
									<li><p>
											<span class="fa fa-phone"></span>${top.fest_tel }</p></li>
								</ul>
								<div class="info-wrap2 d-flex align-items-center">
									<p class="review">
										<span class="rev">조회수 <small>${top.fest_rate }</small></span>
										<span class="ico ion-ios-star"></span><small>(100)</small>
									</p>
									<p class="heart">
										<a href="#"
											class="d-flex align-items-center justify-content-center"><span
											class="ion-ios-heart-empty"></span></a>
									</p>
								</div>
							</div>
						</div>
		...
		<div class="container">
			<div class="row g-0">
				<div class="col-md-4 d-flex align-items-stretch">
					<div class="img w-100"
						style="background-image: url(resources/images/intro.jpg);"></div>
				</div>
					...
					<div class="row py-md-4">
						...
						<div class="col-md-4 d-flex align-items-center">
							<div class="px-4 px-md-0 pb-4 pb-md-0">
								<p>
									<a href="#" class="btn btn-darken py-3 px-4">Show Special
										Offers</a>
								</p>
							</div>
						</div>
	...
	<section class="ftco-section bg-light">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-8 heading-section text-center mb-5"
					data-aos="fade-up" data-aos-duration="1000">
					<span class="subheading">FESTIVAL LIST</span>
					<h2 class="mb-4">축제 정보</h2>
				</div>
			</div>
			<div class="row">
				<c:forEach items="${fest}" var="fest">
					<div class="col-md-6 col-lg-3 d-flex align-items-stretch"
						data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
						<div class="listing-wrap">
							<a href="resources/images/liest_ex.png"
								class="img img-property d-flex align-items-center justify-content-center glightbox"
								style="background-image: url(resources/images/liest_ex.png);">
								<div
									class="icon d-flex align-items-center justify-content-center">
									<span class="fa fa-search"></span>
								</div>
							...
							<div class="text text-center">
								...
								<h3>
									<a onclick="movepage()">${fest.fest_name}</a>
								</h3>
								<ul class="">
									<li><p>
											<span class="ion-ios-pin"></span>${fest.fest_place}</p></li>
									<li><p>
											<span class="fa fa-phone"></span>${fest.fest_tel}</p></li>
								</ul>
								<div class="info-wrap2 d-flex align-items-center">
									<p class="review">
										<span class="rev">조회수<small>${fest.fest_rate}</small></span> <span
		...
		<div class="container-xl">
			<div class="row g-xl-5">
				<div class="col-md-5 d-flex align-items-stretch" data-aos="fade-up"	data-aos-delay="100" data-aos-duration="1000">
					<div class="img w-100" style="background-image: url('resources/letfe/upload/f2a4720c-f369-4a91-b7a6-8a7206d33f5c_춘식이.jpg')" 
					onclick="movepage()"></div>
					
				</div>
				<c:forEach items="${letfe}" var="letfe">
					<div class="col-md-7 py-5 heading-section" data-aos="fade-up"
						...
						<div class="py-md-5">
							...
							<div class="row py-5 g-2">
								...
								<div class="col-md-6 col-lg-3 d-flex align-items-stretch">
									<div class="counter-wrap" data-aos="fade-up"
										data-aos-delay="200" data-aos-duration="1000">
										<div class="text">
											<span class="d-block number gradient-text"><span
												id="count2" class="counter" data-count="${letfe.lf_party}"></span></span>
											<p>참여신청인원</p>
										</div>
									</div>
								</div>
								<div class="col-md-6 col-lg-3 d-flex align-items-stretch">
									<div class="counter-wrap" data-aos="fade-up"
										...
										<div class="text">
											<span class="d-block number gradient-text"><span
												id="count2" class="counter"
												data-count="${letfe.lf_party_max}"></span></span>
											<p>참여마감인원</p>
										</div>
									</div>
								</div>
		...
		<div class="container-xl">
			<div class="row justify-content-center pb-4">
				...
				<div class="col-md-7 text-center heading-section" data-aos="fade-up"
					...
					<span class="subheading">AFTER_ONLINE</span>
						...
						<c:forEach items="${aon }" var="aon">
							<div class="item">
								<div class="testimony-wrap">
									...
									<div class="text">
										<p class="mb-4 msg">${aon.goods_comment }</p>
										<div class="d-flex align-items-center">
											<div class="user-img"
												style="background-image: url(resources/images/list_exexe.png)" onclick="movepage()"></div>
											<div class="pl-3 tx">
												<p class="name">${aon.goods_name }</p>
												<span class="position">${aon.goods_price } 원</span>
											</div>
										</div>
									</div>
								</div>
	...
	<section class="img v-section ftco-section">
		...
		<div class="container-xl">
			<div class="row justify-content-center">
				<div
					class="col-md-8 heading-section heading-section-white text-center mb-5"
					data-aos="fade-up" data-aos-duration="1000">
					<span class="subheading">Let's Find Out</span>
					<h2 class="mb-4">축제 홍보 영상 <br/> (밑에 링크 연결/설명 정도? 안 써도 무관)</h2>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-md-12" data-aos="fade-up" data-aos-delay="100"
					data-aos-duration="1000">
					<div
						class="vid-img img d-flex align-items-center justify-content-center"
						style="background-image: url(resources/images/rachun.png);">
						<a href="https://youtu.be/xZSaR6DaANE"
							class="icon-video glightbox d-flex align-items-center justify-content-center">
			...
			<div class="row">
				<div class="col-md-3 d-flex">
					<div class="blog-entry justify-content-end" data-aos="fade-up"
						...
						<div class="text">
							<p class="meta">
								<span>Dec. 05, 2020</span><a href="#">3 Comments</a>
							</p>
				...
				<div class="col-md-3 d-flex">
					<div class="blog-entry justify-content-end" data-aos="fade-up"
						...
						<div class="text">
							...
							<h3 class="heading mb-3">
								<a href="#">Explore The Best Restaurant in New York</a mb-3>
							</h3>
							<p>A small river named Duden flows by their place and
								supplies it with the necessary regelialia.</p>
						</div>
