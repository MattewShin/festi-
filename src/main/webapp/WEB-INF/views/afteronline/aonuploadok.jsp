...
<head>
  ...
  <!--  나이스 페이지 -->
	...
	<link rel="stylesheet" href="resources/afteronline/css/aonuploadok.css" media="screen">
    ...
    <div class="container-xl">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
   				<ul class="navbar-nav m-auto mb-2 mb-lg-0">
					...
					<!-- 추가  -->
					<li class="nav-item"><a class="nav-link" href="afteronline"> AfterOnline </a></li>
				</ul>
...
<body class="u-body u-xl-mode">
    ...
    <section class="u-clearfix u-section-1" id="sec-c6c5">
      ...
      <br/><br/><br/><br/>
        ...
        <h2 class="u-text u-text-default u-text-1">등록이 완료 되었습니다.</h2>
