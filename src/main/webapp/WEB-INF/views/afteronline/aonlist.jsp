...
<link rel="stylesheet" href="resources/afteronline/css/styleDW.css">
...
<body>
		...
		<div class="container">
			<div id="carouselExampleIndicators" class="carousel slide"
				...
				<div class="carousel-inner">
					<div class="carousel-item active">
						<img src="resources/afteronline/images/bg_3.jpg"
							class="d-block w-100" alt="...">
					</div>
					<div class="carousel-item">
						<img src="resources/afteronline/images/ddd.jpg"
							class="d-block w-100" alt="...">
					</div>
					<div class="carousel-item">
						<img src="resources/afteronline/images/skuy.jpg" class="d-block w-100" alt="...">
					</div>
				</div>
			...
			<div
				...
				<div class="col-md-9 pt-5 text-center">
					<h1 class="mb-0 bread">After Online</h1>
					<p class="breadcrumbs">최고의 축제물품 온라인 쇼핑몰!!!</p>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="ftco-section ftco-no-pb bg-light">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-8 mb-5 pb-md-3 heading-section">
					<div class="text-center w-100">
						<h2 class="mb-3">
						<a href="goodsupload">가보지 못하거나 아쉽게 놓친 물품들이 있다면 검색해 보세요!</a></h2>
					</div>
							...
							<div class="col-md d-flex">
								<div class="form-group p-3 border-0">
									<div class="form-field">
										...
										<input type="text" class="form-control" placeholder="무엇을 찾고 계신가요?">
									</div>
								</div>
							</div>
									...
									<div class="form-field">
										<div class="select-wrap">
											...
											<select name="" id="" class="form-control">
												...
												<option value="">축제명</option>
												<option value="">축제물품명</option>
			...
			<div class="row g-0">
				<div class="col-md-12">
					<div class="row g-3">
						<div class="col-md-4 col-lg-2 text-center d-flex align-items-stretch"
				...
				<div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
					<div class="listing-wrap">
						<a href="aonlook"
							...
							style="background-image: url(resources/afteronline/aoupload/${aList.img_save});">
						...
						<div class="text text-center">
							...
							<h3>
								<a href="aonlook?goods_code=${aList.goods_code}">${aList.goods_name}</a>
							</h3>
							<ul class="">
								<li><p>${aList.goods_comment}</p></li>
							</ul>
	...
	<script
		...
		integrity="sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p"
		crossorigin="anonymous"></script>
	<script src="https://kit.fontawesome.com/9b2ee63470.js" crossorigin="anonymous"></script>
